  ...
  render() {
    ...
    return (<Form onSubmit={this.onSubmit} loading={loading}>
      ...
      <Form.Field error={!!errors.email}>
        ...
        <input type="email" id="email" name="email" placeholder="example@example.com" value={data.email} onChange={this.onChange}/> {errors.email && <InlineError text={errors.email}/>}
      </Form.Field>
